...
function Home() {
   ...
   if (!userData) {
    return (
        ...
        <div className='flex justify-start items-center h-[90%] w-full' style={{ backgroundImage: `url(${Hero})` }}>
         <div className="space-y-5 w-3xl p-16">
            <div className='text-gray-800 font-serif space-y-10'>
